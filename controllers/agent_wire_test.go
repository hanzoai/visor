...
// TestNoOrgContextIsRefused pins the fail-closed case: with neither a Bearer nor
// an ?owner there is no tenant, and the ops must refuse rather than read
// whatever the empty org happens to hold.
