...
type MetricsRegistrationResponse struct {
	// Registration is a metric_go_proto.MetricRegistration as the protocol
	// buffer states it. The RPC carries the bytes: a message generated by
	// another tool declares its own wire, and re-stating it here would be a
...
func (u *Metrics) GetRegisteredMetrics(_ *GetRegisteredMetricsOpts, out *MetricsRegistrationResponse) error {
	...
	out.Registration, err = proto.Marshal(registration)
	return err
}
